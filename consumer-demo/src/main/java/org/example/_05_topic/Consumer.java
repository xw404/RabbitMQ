...
public class Consumer {
    private final static String EXCHANGE_NAME = "05_topic";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind( queue,EXCHANGE_NAME,"employee.*");
        //使用channel取消息消费
        /*
        参数1 对列名称
        参数2 是否自动签收
        ...
        new DeliverCallback() {
            ...
            public void handle(String s, Delivery delivery) throws IOException {
                System.out.println("消费者1：employee消息为："+new String(delivery.getBody()));
            }
        }, new CancelCallback() {
            /**
             * 消息取消了会回调这个方法
